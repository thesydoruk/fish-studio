...
def test_parse_source_ignores_legacy_clip_cap_suffix() -> None:
    source = parse_source("rishchen/pani-nina=nina#40000")

    assert source.speaker == "nina"
    assert source.repo_id == "rishchen/pani-nina"
